...
@Service
public class OAthUserDetailesServiceImpl extends BaseServiceImpl<com.yhl.oauth2server.entity.OAthUserDetailes,String> implements OAthUserDetailesService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        OAthUserDetailes oAthUserDetailes =list.get(0);
